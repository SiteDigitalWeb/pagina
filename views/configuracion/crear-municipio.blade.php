...
<div class="container">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Crear</strong> Municipio</h2>
                                    </div>
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/crearmunicipio/'.Request::segment(3)))) }}

                                        
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Nombre</label>
                                            <div class="col-md-9">
                                                {{Form::text('municipio', '', array('class' => 'form-control','placeholder'=>'Ingrese Municipio','required' => 'required'))}}
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                {{Form::text('p_municipio', '', array('class' => 'form-control','placeholder'=>'Ingrese Valor','required' => 'required'))}}
                                            </div>
                                        </div>
                                          {{Form::hidden('departamento_id', Request::segment(3), array('class' => 'form-control','placeholder'=>'Ingrese País','required' => 'required'))}}
  ...
  <script src="/validaciones/carrito/crear-municipio.js" type="text/javascript"></script>
