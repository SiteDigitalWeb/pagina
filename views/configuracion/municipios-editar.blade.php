 ...
 <div class="container">
  ...
  @if($status=='ok_create')
   <div class="alert alert-success">
    ...
    <strong>Municipio registrado con éxito</strong>
   </div>
  @endif
  ...
  @if($status=='ok_delete')
   <div class="alert alert-danger">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
    <strong>Municipio eliminado con éxito</strong>
   </div>
  @endif
  ...
  @if($status=='ok_update')
   <div class="alert alert-warning">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
    <strong>Municipio actualizado con éxito</strong>
   </div>
  @endif
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Editar</strong> Municipio</h2>
                                    </div>
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/actualizarmunicipio',$departamento->id))) }}

                                        
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Nombre</label>
                                            <div class="col-md-9">
                                                {{Form::text('municipio', $departamento->municipio, array('class' => 'form-control','placeholder'=>'Ingrese País','required' => 'required'))}}
                                            </div>
                                        </div>


                                         <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Costo envio</label>
                                            <div class="col-md-9">
                                                {{Form::text('p_municipio', $departamento->p_municipio, array('class' => 'form-control','placeholder'=>'Ingrese País','required' => 'required'))}}
                                            </div>
                                        </div>
                                          {{Form::hidden('departamento_id', $departamento->departamento_id, array('class' => 'form-control','placeholder'=>'Ingrese País','required' => 'required'))}}
