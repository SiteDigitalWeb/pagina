@extends ('adminsite.layout')
 ...
 <div class="content-header">
     <ul class="nav-horizontal text-center">
      ...
      <li class="active">
       <a href="/gestion/carrito/envio"><i class="fa fa-truck"></i>Envio</a>
      </li>
      <li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Editar</strong> País</h2>
                                    </div>
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/actualizarpais',$pais->id))) }}

                                        
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Nombre</label>
                                            <div class="col-md-9">
                                                {{Form::text('pais', $pais->pais, array('class' => 'form-control','placeholder'=>'Ingrese País','required' => 'required'))}}
                                            </div>
                                        </div>
