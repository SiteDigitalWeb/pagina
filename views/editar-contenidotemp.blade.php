                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/contenidos/actualizartemp',$contenido->id))) }}
                                        ...
                                        <div class="form-group">
                                         ...
                                         {{Form::hidden('redireccion', Request::get('pagina'), array('class' => 'form-control'))}}
  ...
  <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(array('method' => 'GET','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/contenidos/actualizartemp',$contenido->id))) }}
