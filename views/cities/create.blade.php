...
<div class="container">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Crear</strong> Departamento</h2>
                                    </div>
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(['route' => 'sd.city.store', 'method' => 'POST', 'class' => 'form-horizontal', 'id' => 'defaultForm']) }}
                                        
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Nombre</label>
                                            <div class="col-md-9">
                                                {{Form::text('departamento', '', array('class' => 'form-control','placeholder'=>'Ingrese Departamento','required' => 'required'))}}
                                            </div>
                                        </div>
                                          
                                        <div class="form-group">
    <label class="col-md-3 control-label" for="country_id">País</label>
    <div class="col-md-9">
        {{ Form::select('pais_id', 
            $countries->pluck('pais','id'), 
            null, 
            ['class' => 'form-control', 'placeholder' => 'Seleccione un país', 'required' => 'required']) 
        }}
    </div>
</div>
  ...
  <script src="/validaciones/carrito/crear-departamento.js" type="text/javascript"></script>
