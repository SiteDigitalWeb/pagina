                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     ...
                                     {{ Form::open(array('files' => true,'method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('/gestion/creartemplate'))) }}
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                {{Form::textarea('css', '', array('class' => 'form-control','placeholder'=>'Ingrese Mensaje head','required' => 'required'))}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                {{Form::textarea('javascript', '', array('class' => 'form-control','placeholder'=>'Ingrese Mensaje head','required' => 'required'))}}
                                            </div>
                                        </div>
