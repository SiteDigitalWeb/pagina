                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <!-- Basic Form Elements Content -->
                                      ...
                                      {{ Form::open(array('files' => true,'method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/contenidos/actualizarservicio'))) }}
                                         @foreach($datos as $datos)
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Correo</label>
                                            <div class="col-md-9">
                                                 {{Form::text('correo', $datos->correo, array('class' => 'form-control', 'placeholder'=>'Ingrese correo'))}}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-email-input">Sujeto</label>
                                            <div class="col-md-9">
                                                 {{Form::text('sujeto', $datos->sujeto, array('class' => 'form-control', 'placeholder'=>'Ingrese sujeto'))}}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-password-input">Mensaje</label>
                                            <div class="col-md-9">
                                               {{Form::text('mensaje', $datos->mensaje, array('class' => 'form-control', 'placeholder'=>'Ingrese mensaje'))}}
                                            </div>
                                        </div>
