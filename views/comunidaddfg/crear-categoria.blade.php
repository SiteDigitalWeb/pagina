                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <!-- Basic Form Elements Content -->
                                      {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/comunidad/crearcate-comunidad'))) }}
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-select">Tipo de contenido</label>
                                            <div class="col-md-9">
                                                {{ Form::select('webtipo', [
                                                   '1' => 'Dinamizadores de clase',
                                                   '2' => 'Contenido General'], null, array('class' => 'form-control','placeholder'=>'Seleccione tipo de contenido')) }}
                                             </div>
                                        </div>
