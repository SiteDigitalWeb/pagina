                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Editar</strong> Grado</h2>
                                    </div>
                                    <!-- END Form Elements Title -->
                                    
                                    <!-- Basic Form Elements Content -->
                                      {{ Form::open(array('method' => 'PUT','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/comunidad/editargrado',Request::segment(4)))) }}
                                        
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Grado</label>
                                            <div class="col-md-9">
                                               {{Form::text('grado', $grado->grado_comunidad, array('class' => 'form-control','placeholder'=>'Ingrese titulo','required' => 'required'))}}
                                            </div>
                                        </div>

                                          {{Form::hidden('area_id', $grado->area_id, array('class' => 'form-control','placeholder'=>'Ingrese grado','required' => 'required'))}}
