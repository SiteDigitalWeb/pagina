                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Crear</strong> Grado</h2>
                                    </div>
                                    <!-- END Form Elements Title -->
                                    
                                    <!-- Basic Form Elements Content -->
                                      {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/comunidad/creargrado'))) }}

                                        
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Grado</label>
                                            <div class="col-md-9">
                                               {{Form::text('grado', '', array('class' => 'form-control','placeholder'=>'Ingrese grado','required' => 'required'))}}
                                            </div>
                                        </div>

                                            {{Form::hidden('area_id', Request::segment(4), array('class' => 'form-control','placeholder'=>'Ingrese grado','required' => 'required'))}}
